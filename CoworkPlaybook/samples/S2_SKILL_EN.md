...
1. **This Week's Summary** (3 sentences max, focused on client value)
2. **Completed Items** (bulleted; note the business benefit of each)
3. **In Progress** (bulleted; include expected completion time)
4. **Next Week's Plan** (bulleted)
5. **Items Needing Client Help** (bulleted; if none, write "None this week")
6. **Risks & Issues** (bulleted; neutral, solution-oriented tone)

...
6. **Recommendations for next quarter**: 3 opportunities to pursue, with priority
7. **Joint growth roadmap**: a milestone timeline for the next 2-3 quarters
8. **Next steps & actions**: clear owners and timing

## Style Requirements
- Business-professional and concise; no more than 5 bullets per slide.
- Narrate from the customer's point of view ("you" rather than "our product").
